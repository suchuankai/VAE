...
class EstrusDataset():
    ...
    def read_csv(self,data_path):
        ...
        for i in range(24,len(hours)-24):  
            ...
            if(save ):    
                ...
                if( int(oestrusl[i:i+1].values.tolist()[0][0]) or int(oestrusl[i-24:i-23].values.tolist()[0][0]) or int(oestrusl[i+24:i+25].values.tolist()[0][0])):
                    estrus.append(0)
                    estrus.append(1)
                    target.append(1)
                else:
    ...
    def __getitem__(self, index):
        ...
        return self.dataset[index], self.label[index], self.target[index]
